...
import FoodInnovationImg from "../../assets/images/About Research Units/Food Innovation Lab.jpg";
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-10">
            <div className="max-w-4xl">
              ...
              <p className="mt-2 text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-2xl">
                Developing sustainable solutions for tomorrow's food systems.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 mb-12 lg:mb-16">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl sm:text-4xl font-semibold text-gray-600 mb-7">
              ...
              <div className="space-y-5">
                <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                    Provides equipment for the processing and development of fisheries products. Aids students in 
                    innovating existing products derived from fisheries products. Aims to guide multidisciplinary teams 
                    of students and young professionals through the process of innovation – from identifying challenges 
                    to developing consumer-centric solutions to laboratory prototyping and business model development.
                </p>
              </div>
            </div>
