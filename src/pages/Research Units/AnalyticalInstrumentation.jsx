            ...
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                    Provides and conducts microbiological analyses as requested and specified by different 
                    clients who come from all walks of life (domestic, academic, research or industrial sectors 
                    within the university). The preparation room is used to store weak and strong/hazardous 
                    chemicals to avoid accidents in the laboratory. All procedures are carried out in accordance 
                    with established safety protocols and quality control standards to ensure accurate and reliable 
                    results.
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-9">
              {[
                ...
                { name: "Biological Sample Analysis", icon: Dna },
                { name: "Geological Sample Analysis", icon: Mountain },
                { name: "Environmental Sample Analysis", icon: Leaf }
              ].map((service, index) => {
