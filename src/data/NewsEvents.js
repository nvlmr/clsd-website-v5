...
const NewsEvents = [
  ...
  },
  {
    ...
    attachments: [
      { name: "Conference Program.pdf", url: sampleDocument },
      { name: "Presentation Abstract.pdf", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Grant Guidelines.pdf", url: sampleDocument },
      { name: "Application Form.docx", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Project Brief.pdf", url: sampleDocument },
      { name: "Implementation Plan.pdf", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "GIS Workshop Syllabus.pdf", url: sampleDocument },
      { name: "QGIS Tutorial.pdf", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Symposium Program.pdf", url: sampleDocument },
      { name: "Presentation Slides.pdf", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Scholarship Guidelines.pdf", url: sampleDocument },
      { name: "Application Form.docx", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Project Proposal.pdf", url: sampleDocument },
      { name: "Community Engagement Plan.pdf", url: sampleDocument }
    ],
    event_start_date: "2025-01-01",
    event_end_date: "2027-12-31",
  ...
  },
  {
    ...
    attachments: [
      { name: "Workshop Outline.pdf", url: sampleDocument },
      { name: "Writing Resources.pdf", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Conference Brochure.pdf", url: sampleDocument },
      { name: "CLSD Poster.pdf", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Fellowship Description.pdf", url: sampleDocument },
      { name: "Application Requirements.pdf", url: sampleDocument }
    ],
  ...
  },
  {
    ...
    attachments: [
      { name: "Network Expansion Plan.pdf", url: sampleDocument },
      { name: "Monitoring Protocol.pdf", url: sampleDocument }
    ],
    event_start_date: "2025-01-01",
